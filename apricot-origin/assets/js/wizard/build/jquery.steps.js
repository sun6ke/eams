...
function refreshStepNavigation(wizard, options, state, oldIndex)
{
    ...
    var $currentBody = stepTitles.eq(state.currentIndex).next(".body");
    var bodyHeight = $currentBody.height();
    var padding = $currentBody.innerHeight() - bodyHeight;
    bodyHeight += padding;
    $("html, body").animate({ scrollTop: 0 }, "slow");
    $currentBody.after('<div class="' + options.clearFixCssClass + '"></div>');
    $currentBody.parent().animate({ height: bodyHeight }, "slow");
}
